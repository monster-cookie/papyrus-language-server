...
Parsed declarations, call sites, and syntax-backed identifier occurrences are persisted in immutable schema-v5 generations under the platform cache directory:
