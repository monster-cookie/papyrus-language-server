...
#[test]
fn malformed_messages_do_not_terminate_the_session() {
    ...
    client_connection
        ...
        .send(Message::Notification(Notification::new(
            ...
            json!({ "not": "valid didChange params" }),
        )))
        .unwrap();
    let uri = "file:///workspace/StillAlive.psc";
    client_connection
        .sender
        .send(Message::Notification(Notification::new(
    ...
    client_connection
        ...
        .send(Message::Request(Request {
            ...
            params: json!({ "not": "valid completion params" }),
        }))
        .unwrap();
    let response = client_connection
        .receiver
        .recv_timeout(Duration::from_secs(5))
        .expect("invalid-params response should arrive");
    ...
    client_connection
        ...
        .unwrap();
    let symbols = receive_response(&client_connection);
    assert_eq!(symbols[0]["name"], "StillAlive");
